...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        setSize(1000,650);
        FormTB p1=new FormTB();
        jTabbedPane1.add("thong tin thiet bi",p1);
        FormPH p2=new FormPH();
        jTabbedPane1.add("thong tin phong hoc",p2);
        FormQLTB p3=new FormQLTB();
        jTabbedPane1.add("quan ly thiet bi",p3);
    }
