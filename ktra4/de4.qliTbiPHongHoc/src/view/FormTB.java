 ...
 * @author DELL
 */
public class FormTB extends javax.swing.JPanel {
    ...
    public FormTB() {
        ...
        setSize(900,600);
        String[] cols={
            "ma tbi","ten tbi","xuat xu","nam"
        };
        tm=new DefaultTableModel(cols,0);
        jTable1.setModel(tm);
        buttonTrue();
        them=false;sua=false;
        file="src/controller/tb.dat";
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!ok){
            if(f.exists()){
                List<ThietBi> list=IOFile.docra(file);
                if(list.size()>0){
