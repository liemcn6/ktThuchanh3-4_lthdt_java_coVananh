...
public class main extends javax.swing.JFrame {
    ...
    public main() {
        initComponents();
        setSize(1000,650);
        FormPH p1=new FormPH();
        jTabbedPane1.add("thong tin phong hoc",p1);
        FormL p2=new FormL();
        jTabbedPane1.add("thong tin lop hoc",p2);
        FormBSX p3=new FormBSX();
        jTabbedPane1.add("bang sap xep",p3);
    }
