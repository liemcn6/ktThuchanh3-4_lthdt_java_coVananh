...
public class main extends javax.swing.JFrame {
    ...
    public main() {
        initComponents();
        setSize(1000,650);
        FormDV p1=new FormDV();
        jTabbedPane1.add("thong tin dich vu",p1);
        FormNV p2=new FormNV();
        jTabbedPane1.add("thong tin nhan vien",p2);
        FormDSBH p3=new FormDSBH();
        jTabbedPane1.add("danh sach ban hang",p3);
