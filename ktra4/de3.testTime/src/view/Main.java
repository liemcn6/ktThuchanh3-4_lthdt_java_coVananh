...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        setSize(1000, 650);
        FormNV p1=new  FormNV();
        jTabbedPane1.add("thong tin nhan vien",p1);
        FormPB p2=new FormPB();
        jTabbedPane1.add("thong tin phong ban",p2);
        FormDSCC p3=new FormDSCC();
        jTabbedPane1.add("danh sach cham cong ",p3);
    }
