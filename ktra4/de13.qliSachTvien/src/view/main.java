...
public class main extends javax.swing.JFrame {
    ...
    public main() {
        initComponents();
        setSize(1000,650);
        FormSach s=new FormSach();
        jTabbedPane1.add("thong tin sach",s);
        FormKS k=new FormKS();
        jTabbedPane1.add("thong tin ke sach",k);
        FormBQLS f=new FormBQLS();
        jTabbedPane1.add("bang quan li muon",f);
    }
