 ...
 * @author DELL
 */
public class C extends javax.swing.JDialog {

    /**
     * Creates new form B
     */
    private A p;
    public C(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        p=(A) parent;
        initComponents();
        Sach s=p.send();
        ...
        jTextField3.setText(s.getSoluong()+"");
        jTextField4.setText(s.getDongia()+"");
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                C dialog = new C(new javax.swing.JFrame(), true);
