 ...
 * @author DELL
 */
public class ThemDialog extends javax.swing.JDialog {

    /**
     * Creates new form DialogForm
     */
    private FrameForm p;
    public ThemDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        p=(FrameForm) parent;
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemDialog dialog = new ThemDialog(new javax.swing.JFrame(), true);
