...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        initComponents();
//        String[] cols={"Ma","Ho ten","Gioi tinh",
//                       "Que quan","Diem"};
...
//        jTable1.setModel(tm);
    ...
    private void initComponents() {
        ...
        btTKiem = new javax.swing.JButton();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ma", "Ho va ten", "Gioi tinh", "Que quan", "Diem"
            }
        ));
        ...
        btSapXep.setText("Sap xep theo diem");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(42, 42, 42)
                        .addComponent(btBoQua, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(49, 49, 49)
                        .addComponent(btXoa, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(27, 27, 27)
                .addComponent(btTKiem))
        );
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(sua){
            ...
            tm.setValueAt(jTextField1.getText(),
                    r,0);
            tm.setValueAt(jTextField2.getText(),
                    r,1);
            boolean gt=false;
            if(jRadioButton1.isSelected())
                gt=true;
            tm.setValueAt(gt?"Nam":"Nu", r, 2);
            tm.setValueAt(jComboBox1.getSelectedItem().toString(), 
                    r, 3);
            tm.setValueAt(jTextField3.getText(), r,
                    4);
            buttonTrue();
            sua=false;
        }
    ...
    private void btLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLuuActionPerformed
        ...
        for (int i = 0; i < tm.getRowCount(); i++) {
            ...
            s.setQq(tm.getValueAt(i,3).toString());
            s.setDiem(Double.parseDouble(tm.getValueAt(i,4).toString()));
            list.add(s);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String qq=tm.getValueAt(r,3).toString();
        for (int i = 0; i < jComboBox1.getItemCount(); i++) {
            if(jComboBox1.getItemAt(i).toString().equals(qq)){
